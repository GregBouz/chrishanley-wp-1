    	...
    	<?php if(get_option('woo_home_layout') == "With sidebar") { ?>
    		...
    		<div id="listings" class="with-sidebar">
        	    ...
        	    <div class="property <?php if($count == 3){ echo 'last'; $count = 0; }?>" >
        	     ...
        	     <?php if(get_option('woo_archives_link') == 'true') { ?><a class="archives-link" href="<?php echo $search_all_properties_page; ?>" title="View All Properties">&middot; <?php _e('View all featured properties', 'woothemes') ?> &middot;</a><?php } ?>
