    ...
    <div id="content" class="col-full">
		...
		<?php if(get_option('woo_property_search_layout') == "With sidebar") { ?>
    		...
    		<div id="listings" class="with-sidebar">
					...
					<span class="archive_header"><span class="fl cat"><?php _e('Property Archive', 'woothemes');  ?></span> <span class="fr catrss"><?php echo '<a href="'; echo get_post_type_archive_feed_link( 'woo_estate' ); echo '">'.__( 'RSS feed for this section', 'woothemes' ).'</a>'; ?></span></span>        
