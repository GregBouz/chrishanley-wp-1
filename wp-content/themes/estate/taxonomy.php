...
global $woo_options; 
global $wp_query; 
//get taxonomy names and details
...
?>
    <div id="content" class="col-full">
		...
		<?php if(get_option('woo_property_archive_layout') == "With sidebar") { ?>
    		
    		<div id="listings" class="with-sidebar">
    			
       		 	<?php if (have_posts()) : $count = 0; ?>
					
           			<span class="archive_header"><span class="fl cat"><?php _e('Property Archive', 'woothemes');  ?> | <?php echo $taxonomy_nice_name;?></span> <span class="fr catrss"><?php echo '<a href="'; echo get_term_feed_link( $term_id, $taxonomy_short_name, ''); echo '">RSS feed for this section</a>'; ?></span></span>        
           			
           			<div class="fix"></div>
        		<?php while (have_posts()) : the_post(); $count++; $has_results = true; ?>
        	    <?php 
    			...
    			<div class="property <?php if($count == $woo_options['woo_more_entries']){ echo 'last'; $count = 0; }?>" >
